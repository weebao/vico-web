...
## API Key
* Create an API Key in Google Cloud Console (https://console.cloud.google.com/). Enable the Map Tiles API and Street View Static API in Library (https://console.cloud.google.com/apis/library/), and keep your key in `secret.txt`
